...
function main() {
    ...
    puppeteer
        ...
        .then(async (browser) => {
            ...
            await oneCycle(page, credentials, folderPath, screenshotPath);
...
async function oneCycle(page, credentials, folderPath, screenshotPath) {
    const __url__ = `https://new.elama.ru/my`;
